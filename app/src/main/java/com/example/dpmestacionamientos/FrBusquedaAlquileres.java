...
public class FrBusquedaAlquileres extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayAdapter<String> adaptadorEstacionamientos = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, estacionamientos);
        ...
        Spinner comboEstacionamientos = (Spinner) view.findViewById(R.id.spinnerEstacionamiento);
